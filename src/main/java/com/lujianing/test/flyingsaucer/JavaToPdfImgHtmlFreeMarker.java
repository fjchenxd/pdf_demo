...
public class JavaToPdfImgHtmlFreeMarker {
    ...
    private static final String PEF_DEST = "target/HelloWorld_CN_HTML_FREEMARKER.pdf";
...
//        FileOutputStream fileStream = new FileOutputStream(new File(DEST));
        FileOutputStream fileStream = new FileOutputStream(new File(PEF_DEST));
//        fileStream.write(imgSteam.toByteArray());
        fileStream.write(pdfStream.toByteArray());
        fileStream.close();
